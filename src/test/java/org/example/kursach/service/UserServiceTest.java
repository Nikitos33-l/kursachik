...
public class UserServiceTest {
    ...
    @Test
    @DisplayName("Сохранение пользователя с несуществующим email")
    public void successful_save_user(){
        User user = create_user(null,"111","Иван","ivan@gmail.com");
        ...
        verify(passwordEncoder,times(1)).encode("111");
    }

    @Test
    @DisplayName("Сохранение пользователя с несуществующим email")
    public void bad_email_save_user(){
        User user = create_user(null,"111","Иван","ivan@gmail.com");

        when(userRepository.findByEmail(user.getEmail())).thenReturn(create_user(1L,"","","ivan@gmail.com"));
        ...
        verify(passwordEncoder,times(0)).encode("111");
    }
