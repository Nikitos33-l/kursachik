...
import org.example.payment.service.dto.yookassa.request.Amount;
import org.example.payment.service.dto.yookassa.request.Confirmation;
import org.example.payment.service.dto.yookassa.request.YooKassaRequest;
import org.example.payment.service.dto.yookassa.responce.YooKassaResponse;
...
public class YooKassaExternalService implements ExternalPaymentService {
    ...
    private YooKassaRequest buildRequest(PaymentDetails paymentDetails){
        ...
        return new YooKassaRequest(
                new Amount(paymentDetails.amount().toPlainString(), "RUB"),
                true,
